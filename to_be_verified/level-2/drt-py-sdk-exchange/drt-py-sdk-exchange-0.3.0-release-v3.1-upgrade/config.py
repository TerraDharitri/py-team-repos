...
# Used net
DEFAULT_PROXY = "https://devnet-gateway.dharitri.org"                     # Proxy to be used for ALL operations
DEFAULT_API = "https://devnet-api.dharitri.org"                           # API to be used for ALL operations
GRAPHQL = 'https://graph.dharitrix.org/graphql'                              # GraphQL service; only needed for the upgrader scripts
...
GOVERNANCE_BYTECODE_PATH = "https://github.com/TerraDharitri/drt-exchange-sc/releases/download/v3.0.8/governance-v2.wasm"
POSITION_CREATOR_BYTECODE_PATH = "https://github.com/TerraDharitri/drt-exchange-tools-sc/releases/download/v1.0.0-rc3/auto-pos-creator.wasm"
LOCKED_TOKEN_POSITION_CREATOR_BYTECODE_PATH = "https://github.com/TerraDharitri/drt-exchange-tools-sc/releases/download/v1.0.0-rc3/locked-token-pos-creator.wasm"
...
COMPOSABLE_TASKS_BYTECODE_PATH = "https://github.com/TerraDharitri/drt-exchange-tools-sc/releases/download/v1.0.0-rc3/composable-tasks.wasm"


# ------------ Generic configuration below; Modify only in case of framework changes ------------ #
TOKENS_CONTRACT_ADDRESS = "drt1yvesqqqqqqqqqqqqqqqqqqqqqqqqyvesqqqqqqqqqqqqqqqzlllsd5j0s2"
SF_CONTROL_ADDRESS = "drt1yvesqqqqqqqqqqqqqqqqqqqqqqqqyvesqqqqqqqqqqqqqqqplllsphc9lf"
