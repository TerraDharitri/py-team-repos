...
def test_lock_tokens_valid_option_1(context, account: Account, simple_lock_energy_contract: SimpleLockEnergyContract):
    token = DCDTToken(simple_lock_energy_contract.base_token, 0, nominated_amount(1000))
    expected_token = DCDTToken(simple_lock_energy_contract.locked_token, 1, token.token_amount)
    args = [[token], 2]
...
def test_lock_tokens_valid_option_2(context, account: Account, simple_lock_energy_contract: SimpleLockEnergyContract):
    token = DCDTToken(simple_lock_energy_contract.base_token, 0, nominated_amount(1000))
    expected_token = DCDTToken(simple_lock_energy_contract.locked_token, 2, token.token_amount)
    args = [[token], 6]
...
def test_lock_tokens_invalid_option_1(context, account: Account, simple_lock_energy_contract: SimpleLockEnergyContract):
    token = DCDTToken(simple_lock_energy_contract.base_token, 0, nominated_amount(100))
    args = [[token], 5]
...
def test_lock_other_tokens_1(context, account: Account, simple_lock_energy_contract: SimpleLockEnergyContract):
    token = DCDTToken(context.deploy_structure.tokens[1], 0, nominated_amount(100))
    args = [[token], 2]
...
def test_unlock_early_1(context, account: Account, simple_lock_energy_contract: SimpleLockEnergyContract):
    token = DCDTToken(simple_lock_energy_contract.locked_token, 2, nominated_amount(100))
    expected_token = DCDTToken(simple_lock_energy_contract.base_token, 0, token.token_amount)
    args = [[token]]
...
def test_unlock_early_invalid_token_2(context, account: Account, simple_lock_energy_contract: SimpleLockEnergyContract):
    ...
    # create forged token
    token = DCDTToken(context.deploy_structure.tokens[0], 0, nominated_amount(1))
    args = [[token], 30]
    forged_token = DCDTToken(forged_contract.locked_token, 1, 1)
...
def test_reduce_lock_invalid_too_much_1(context, account: Account, simple_lock_energy_contract: SimpleLockEnergyContract):
    token = DCDTToken(simple_lock_energy_contract.locked_token, 1, nominated_amount(100))
    args = [[token], 3]
...
def test_reduce_lock_1(context, account: Account, simple_lock_energy_contract: SimpleLockEnergyContract):
    token = DCDTToken(simple_lock_energy_contract.locked_token, 2, nominated_amount(100))
    expected_token = DCDTToken(simple_lock_energy_contract.locked_token, 1, token.token_amount)
    penalties_token = DCDTToken(simple_lock_energy_contract.base_token, 0, token.token_amount)
    args = [[token], 3]
