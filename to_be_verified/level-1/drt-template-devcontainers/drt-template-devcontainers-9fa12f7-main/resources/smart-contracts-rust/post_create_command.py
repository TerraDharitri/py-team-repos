...
def prepare_vscode_settings():
    ...
    workspace_path = Path("dharitri.workspace.json")
...
def add_samples():
    ...
    archive_url = "https://github.com/TerraDharitri/drt-rs-contracts/archive/refs/heads/main.zip"
    download_path = Path("/tmp/archive.zip")
    extract_path = Path("/tmp/extracted")
    contracts_in_extract_path = Path("drt-rs-contracts-main/contracts")
