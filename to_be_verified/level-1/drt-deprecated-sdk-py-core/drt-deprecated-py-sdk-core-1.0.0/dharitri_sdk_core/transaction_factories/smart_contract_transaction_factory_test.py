...
class TestSmartContractTransactionsFactory:
    ...
    def test_create_transaction_for_execute_no_transfer(self):
        ...
        assert intent.sender == "drt1qyu5wthldzr8wx5c9ucg8kjagg0jfs53s8nr3zpz3hypefsdd8ssey5egf"
        assert intent.receiver == "drt1qqqqqqqqqqqqqpgqhy6nl6zq07rnzry8uyh6rtyq0uzgtk3e69fq4h4xut"
