...
def deploy_position_creator_contract(_):
    ...
    rewa_wrapped_address = context.get_contracts(config.REWA_WRAPS)[1].address
    ...
    moa_wrewa_pair_address = context.get_contracts(config.PAIRS_V2)[0].address
    moa_wrewa_farm_address = context.get_contracts(config.FARMS_V2)[0].address
